        ...
        i("head").append(
          i(
            '<style id="theia-sticky-sidebar-stylesheet-' +
              t.namespace +
              '">.sticky-content-inner:after {content: ""; display: table; clear: both;}</style>'
          )
        ),
        e.each(function () {
          function e() {
          ...
          if (
            ...
            a.sidebar.parent().css("-webkit-transform", "none"),
            a.sidebar.css({
            ...
            (a.stickySidebar = a.sidebar.find(".sticky-content-inner")),

!(function (t) {
  ...
  var e = (function () {
    function e() {
      var e = this,
        n = function () {
          var n = ["br-wrapper"];
          "" !== e.options.theme && n.push("br-theme-" + e.options.theme),
        ...
        o = function () {
          ...
          return !n.length && e.options.allowEmpty
            ? ((n = t("<option />", { value: e.options.emptyValue })),
              n.prependTo(e.$elem))
            : n;
        },
        l = function (t) {
        ...
        u = function () {
          var t = r(),
            ...
            l =
              null !== e.options.allowEmpty ? e.options.allowEmpty : !!n.length,
        ...
        g = function () {
          ...
          return (
            ...
            e.options.showSelectedRating &&
              n.append(t("<div />", { text: "", class: "br-current-rating" })),
        ...
        w = function () {
          ...
          if (
            ...
            (n = e.$widget.find("a")),
              (i = a.length
                ? a[l("userOptions").reverse ? "prev" : "next"]()
                : n[l("userOptions").reverse ? "last" : "first"]()),
        ...
        R = function (e) {
          e.on("mouseenter.barrating", function () {
            var e = t(this);
            b(),
              e.addClass("br-active")[p()]().addClass("br-active"),
      ...
      (this.show = function () {
        ...
        (this.readonly = function (t) {
          "boolean" == typeof t &&
            l("readOnly") != t &&
            (j(t), s("readOnly", t), e.$widget.toggleClass("br-readonly"));
        }),
        (this.set = function (t) {
          var n = l("userOptions");
          e.$elem.find('option[value="' + t + '"]').val() &&
            (s("ratingValue", t),
  ...
  (t.fn.barrating = function (n, i) {
    return this.each(function () {
      ...
      if (
        (t(this).is("select") ||
          t.error("Sorry, this plugin only works with select fields."),
        a.hasOwnProperty(n))
      ) {
